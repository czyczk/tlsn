...
impl Debug for TdnVerifierConfig {
...
impl TdnVerifierConfig {
    /// Create a new configuration builder.
    pub fn builder() -> TdnVerifierConfigBuilder {
        TdnVerifierConfigBuilder::default()
    }
